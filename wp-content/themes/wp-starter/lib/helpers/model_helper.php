 ...
 * @ingroup helperfunc
 */
function new_post_type($name, $plural,  $icona = 'dashicons-admin-post', $supports = array("title", "editor"), $options = array())
{
  ...
  $labels = array(
    ...
    'add_new_item' => sprintf(__("%s", "wl"), $uc_singular),
  ...
  $options = array_merge(array(
    ...
    'query_var' => true,
    'has_archive' => true,
    'rewrite' => array('slug' => preg_replace("/_/", "-", $name["plural"]), "with_front" => false),
    'capability_type' => 'post',
    'hierarchical' => false,
    'menu_position' => null,
    'show_in_graphql'  => true,
    'graphql_single_name'  => str_replace(" ", "", $uc_singular),
    'graphql_plural_name'  => str_replace(" ", "", $uc_plural),
    'supports' => $supports
  ), $options);
 ...
 * @ingroup helperfunc
 */
function new_taxonomy($name, $plural, $post_types, $options = array())
{
